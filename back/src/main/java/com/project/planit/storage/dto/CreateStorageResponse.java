...
public class CreateStorageResponse {
    ...
    public static CreateStorageResponse create(Long memberId, Long storagesId, String name, Boolean confirmed, Double lat, Double lng, Integer dayOrder, Category categoryName, Long roomId) {
